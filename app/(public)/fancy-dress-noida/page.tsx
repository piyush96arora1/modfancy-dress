  ...
  return (
    <div className="fade-in max-w-3xl mx-auto">
      ...
      <div className="space-y-4 text-[#6B6B6B] text-sm leading-relaxed mb-8">
        ...
        <p>For school bulk orders of 50+ costumes, see our <Link href="/wholesale/schools" className="text-[#8F6240] hover:underline font-medium">dedicated schools &amp; bulk orders page</Link>. You can also <Link href="/fancy-dress-delhi" className="text-[#8F6240] hover:underline font-medium">visit our Delhi store</Link> in Krishna Nagar if you prefer to browse in person before ordering delivery to Noida.</p>
      </div>
      ...
      <div className="mt-10 bg-[#FBF5EF] rounded-xl p-5 border border-[#E8E5E0]">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm">
          ...
          <Link href="/category/leaders-freedom-fighters" className="text-[#8F6240] hover:underline font-medium">Freedom fighter costumes</Link>
          <Link href="/category/classical-dance-dress" className="text-[#8F6240] hover:underline font-medium">Classical dance dress</Link>
          <Link href="/category/janmashtami-dress" className="text-[#8F6240] hover:underline font-medium">Janmashtami dress</Link>
